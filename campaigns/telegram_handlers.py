...
def ask_subscription(chat_id, campaign):
    """
    На этапе подписки показываем текст условий и кнопку "Проверить подписку".
    Участник на этом этапе уже ввёл имя и номер.
    """
    text = (
        f"Для участия в розыгрыше необходимо:\n"
        f"• Быть подписанным на наш канал\n"
        f"• Заполнить контактные данные\n"
        f"• Согласиться на обработку персональных данных\n\n"
        f"{campaign.conditions_text or '📋 Ознакомьтесь с условиями акции'}"
    )
